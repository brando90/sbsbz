# MEGA BACHATA PARTY birthday event kit — September 19, 2026

**TLDR:** The version-13 tree flyer, event title, location and description are approved and live on Partiful, with the verified event code, updated instructor credit, map and current links. Invitation copy is saved for Brando to send manually; the separate Linktree website-button correction remains pending.
...
|---|---|
| Current flyer — v13, code verified | [Review flyer](assets/mega_bachata_party_sept19_brando_marta_v13.png) |
...
Current version-13 flyer: https://drive.google.com/file/d/1CoRiYcX50MKqT6IFknMLEbIM6A_MWFhC/view
...
Catering alternative under review: [Holyland recommendation and unsent WhatsApp quote request](holyland-catering-proposal.md). This is not a confirmed vendor replacement; the proposed total budget is $600–$700 and public food details await confirmation.
